...
import UpdatePictureForm from "@/components/UpdatePictureForm";
      ...
      <div className="max-h-[80vh] pt-16 pb-4 px-4 col-span-8 overflow-y-scroll space-y-8">
            ...
            <div className="flex-1 flex flex-col items-start gap-2">
              ...
              <p className="text-lg font-bold">
                ...
                <span className="font-semibold text-sm inline-flex gap-2 items-center">
                  <Star className="size-4 fill-brand-100" /> 5.0 (76 Reviews)
                </span>
              </p>
              <Dialog>
                <DialogTrigger asChild>
        ...
        <div className="space-y-2 p-4 bg-white shadow shadow-black/40 rounded-xl">
          ...
          <p>
            {isFullAbout
              ? session.user.about
              : `${session.user.about.slice(0, 150)}...`}
          </p>
          <Button
            onClick={() => setIsFullAbout((prev) => !prev)}
            className="min-w-32 self-end text-black font-bold rounded-full rounded-bl-none bg-brand-150 shadow"
          >
            {isFullAbout ? "Read less" : "Read more"}
          </Button>
        </div>
        <div className="space-y-2 p-4 bg-white shadow shadow-black/40 rounded-xl">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <PlusCircle
                  size={32}
                  className="text-brand-150 hover:opacity-70 cursor-pointer transition"
                />
              </DialogTrigger>
              <DialogContent>
                <DialogHeader>
        ...
        <div className="space-y-2 p-4 bg-white shadow shadow-black/40 rounded-xl">
          <h3 className="text-xl font-extrabold">Book an Intro Call</h3>
            ...
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Do you want the intro call on Monday 10:00 PM - 12:00 PM
                  </DialogDescription>
                </DialogHeader>

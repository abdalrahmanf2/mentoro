...
import FilterOnRole from "./FilterOnRole";
              ...
              <div key={idx} className="shadow px-8 py-4 rounded-xl">
                <div className="flex flex-col lg:flex-row gap-4" key={idx}>
                  ...
                  <div className="space-y-2">
                    <h3 className="text-4xl font-extrabold">{mentor.name}</h3>
                    <div>
                      <p className="text-md font-semibold">{mentor.role}</p>
                    ...
                    <p>
                      Hello! I&apos;m {mentor.name}, a {mentor.role} with 10
                      years of experience. I have worked for consultancy,
                      startup, and enterprise product companies in differ...
                    </p>
                ...
                <div className="cursor-pointer flex items-center justify-end gap-2">
                  <p className="text-brand-200 font-bold">850/month LE</p>
